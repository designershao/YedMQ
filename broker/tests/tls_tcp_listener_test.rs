...
async fn test_persistent_session() {
    ...
    let mut mqtt_options1 = MqttOptions::new("tls-persistent-client", "localhost", broker_addr.port());
    mqtt_options1.set_keep_alive(Duration::from_secs(5));
    mqtt_options1.set_transport(configure_tls());
    ...
    let mut mqtt_options_pub = MqttOptions::new("tls-persistent-publisher", "localhost", broker_addr.port());
    ...
    // Client 1 Reconnects
    let mut mqtt_options2 = MqttOptions::new("tls-persistent-client", "localhost", broker_addr.port());
    mqtt_options2.set_keep_alive(Duration::from_secs(5));
    mqtt_options2.set_transport(configure_tls());
